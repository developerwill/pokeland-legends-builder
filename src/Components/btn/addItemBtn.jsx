...
const AddItemBtn = ({ modal, index, btnIndex, itemType }) => {
    ...
    if (itemType === 'pokemon') {
        return (
            <button onClick={() => getBtnKey(index)} key={btnIndex} className={btnStyle} type="button" data-bs-toggle="modal" data-bs-target={modal}>
